...
const jobs = [
  ...
  },
  {
    ...
    Icon: Repeat2,
    tone: "text-replace",
    ring: "border-replace/50 bg-replace/15",
  },
];
  ...
  return (
    <div className="flex flex-col gap-10 pb-6 md:gap-14">
      ...
      <section className="relative isolate mx-[calc(50%-50vw)] w-[100vw] overflow-hidden md:min-h-[21rem] lg:min-h-[23rem]">
        ...
        <div className="mx-auto w-full max-w-6xl px-4 pt-4 pb-3 md:pt-6 md:pb-4">
            ...
            <div className="relative z-20 max-w-3xl">
              <h1 className="font-heading text-[2rem] leading-[1.08] font-semibold tracking-[-0.015em] sm:text-[2.25rem] lg:text-[2.5rem]">
                ...
                <span className="block text-primary/85">
                  Using the cards you actually own.
                </span>
              </h1>
          ...
          <div className="mx-auto flex w-full max-w-6xl px-4">
            ...
            >
              {jobs.map(({ name, summary, Icon, tone, ring }) => (
                ...
                >
                  <span
                    className={`flex size-9 shrink-0 items-center justify-center rounded-full border ${ring} ${tone}`}
                  >
                    <Icon aria-hidden className="size-4" strokeWidth={2.5} />
                  </span>
                  <span className="min-w-0">
                    <span className="block font-heading text-base leading-none font-semibold">
                      {name}
                    </span>
          ...
          {[
            {
              ...
              desc: "Paste, or import from Archidekt, ManaBox, Moxfield or TCGplayer.",
            },
            {
              step: 2,
              title: "Import your collection",
              desc: "A CSV or text export from the same apps. Optional.",
            },
            {
              step: 3,
              title: "Find the perfect swaps",
              desc: "Cuts, additions and substitutes, with the price difference before you commit.",
            },
        ...
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="font-heading text-xl font-semibold">
              Your collection. Your deck. Optimized.
            </h2>
